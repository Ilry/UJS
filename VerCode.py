...
def get_vercode(wd, captchaImg):
    ...
    wd.save_screenshot('/Python/data/screenshot.png')
    ...
    img = cv2.imread('/Python/data/screenshot.png', 1)
    img = img[y1:y2, x1:x2, :]
    cv2.imwrite("/Python/data/captcha.jpg", img)

    word = VCodeRec('/Python/data/captcha.jpg')
    return word
